...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux_001                                                                  -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                                 
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                  -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                                 
  ...
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_demux_018.sv"                    -work rsp_xbar_demux_018                                                                -cdslib ./cds_libs/rsp_xbar_demux_018.cds.lib                                                               
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_demux.sv"                        -work rsp_xbar_demux                                                                    -cdslib ./cds_libs/rsp_xbar_demux.cds.lib                                                                   
  ...
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_id_router_018.sv"                         -work id_router_018                                                                     -cdslib ./cds_libs/id_router_018.cds.lib                                                                    
  ...
  ncvlog -sv "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_addr_router_001.sv"                       -work addr_router_001                                                                   -cdslib ./cds_libs/addr_router_001.cds.lib                                                                  
  ...
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_timer_0.v"                                -work timer_0                                                                           -cdslib ./cds_libs/timer_0.cds.lib                                                                          
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_key1.v"                                   -work key1                                                                              -cdslib ./cds_libs/key1.cds.lib                                                                             
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_switch0.v"                                -work switch0                                                                           -cdslib ./cds_libs/switch0.cds.lib                                                                          
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_uart_0.v"                                 -work uart_0                                                                            -cdslib ./cds_libs/uart_0.cds.lib                                                                           
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_LCD_DATA.v"                               -work LCD_DATA                                                                          -cdslib ./cds_libs/LCD_DATA.cds.lib                                                                         
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_LCD_ON.v"                                 -work LCD_ON                                                                            -cdslib ./cds_libs/LCD_ON.cds.lib                                                                           
  ...
  ncvlog     "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
