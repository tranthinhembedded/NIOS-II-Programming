...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_mux_001.sv \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_demux_018.sv \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_demux.sv \
  ...
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_id_router_018.sv \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_id_router.sv \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_addr_router_001.sv \
  ...
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_timer_0.v \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_key1.v \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_switch0.v \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_uart_0.v \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_LCD_DATA.v \
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_LCD_ON.v \
  ...
  $QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_nios2_qsys_0.v \
