...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux_002                                                                 
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_mux_002.sv"                      -work rsp_xbar_mux_002                                                                 
  ...
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/altera_merlin_arbitrator.sv"                       -work cmd_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_cmd_xbar_mux_001.sv"                      -work cmd_xbar_mux_001                                                                 
  ...
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_cmd_xbar_demux_003.sv"                    -work cmd_xbar_demux_003                                                               
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_cmd_xbar_demux_002.sv"                    -work cmd_xbar_demux_002                                                               
  ...
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                  -work limiter                                                                          
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                  -work limiter                                                                          
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_id_router_001.sv"                         -work id_router_001                                                                    
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_id_router.sv"                             -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/nios_sys_tb/simulation/submodules/nios_sys_addr_router_002.sv"                       -work addr_router_002                                                                  
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux_002 -L rsp_xbar_mux -L rsp_xbar_demux_001 -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_003 -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L limiter -L id_router_001 -L id_router -L addr_router_002 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L dma_0 -L jtag_uart_0 -L onchip_memory2_1 -L onchip_memory2_0 -L nios2_qsys_0 -L nios_sys_inst_reset_bfm -L nios_sys_inst_clk_bfm -L nios_sys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
